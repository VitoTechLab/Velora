...
mixin _$CampaignCommentEntity {
 ...
 String get id; String get campaignId; String get userId; String get commentText; String? get parentId; DateTime get createdAt;// Joined from user_profiles (read-only)
 String? get username; String? get displayName; String? get avatarUrl;// For threaded comments
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CampaignCommentEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.campaignId, campaignId) || other.campaignId == campaignId)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.commentText, commentText) || other.commentText == commentText)&&(identical(other.parentId, parentId) || other.parentId == parentId)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.username, username) || other.username == username)&&(identical(other.displayName, displayName) || other.displayName == displayName)&&(identical(other.avatarUrl, avatarUrl) || other.avatarUrl == avatarUrl)&&const DeepCollectionEquality().equals(other.replies, replies));
}


@override
int get hashCode => Object.hash(runtimeType,id,campaignId,userId,commentText,parentId,createdAt,username,displayName,avatarUrl,const DeepCollectionEquality().hash(replies));
...
@useResult
$Res call({
 String id, String campaignId, String userId, String commentText, String? parentId, DateTime createdAt, String? username, String? displayName, String? avatarUrl, List<CampaignCommentEntity> replies
});
...
/// Create a copy of CampaignCommentEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? campaignId = null,Object? userId = null,Object? commentText = null,Object? parentId = freezed,Object? createdAt = null,Object? username = freezed,Object? displayName = freezed,Object? avatarUrl = freezed,Object? replies = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String campaignId,  String userId,  String commentText,  String? parentId,  DateTime createdAt,  String? username,  String? displayName,  String? avatarUrl,  List<CampaignCommentEntity> replies)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CampaignCommentEntity() when $default != null:
return $default(_that.id,_that.campaignId,_that.userId,_that.commentText,_that.parentId,_that.createdAt,_that.username,_that.displayName,_that.avatarUrl,_that.replies);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String campaignId,  String userId,  String commentText,  String? parentId,  DateTime createdAt,  String? username,  String? displayName,  String? avatarUrl,  List<CampaignCommentEntity> replies)  $default,) {final _that = this;
switch (_that) {
case _CampaignCommentEntity():
return $default(_that.id,_that.campaignId,_that.userId,_that.commentText,_that.parentId,_that.createdAt,_that.username,_that.displayName,_that.avatarUrl,_that.replies);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String campaignId,  String userId,  String commentText,  String? parentId,  DateTime createdAt,  String? username,  String? displayName,  String? avatarUrl,  List<CampaignCommentEntity> replies)?  $default,) {final _that = this;
switch (_that) {
case _CampaignCommentEntity() when $default != null:
return $default(_that.id,_that.campaignId,_that.userId,_that.commentText,_that.parentId,_that.createdAt,_that.username,_that.displayName,_that.avatarUrl,_that.replies);case _:
  return null;
...
class _CampaignCommentEntity implements CampaignCommentEntity {
  const _CampaignCommentEntity({required this.id, required this.campaignId, required this.userId, required this.commentText, this.parentId, required this.createdAt, this.username, this.displayName, this.avatarUrl, final  List<CampaignCommentEntity> replies = const []}): _replies = replies;
...
// For threaded comments
@override@JsonKey() List<CampaignCommentEntity> get replies {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CampaignCommentEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.campaignId, campaignId) || other.campaignId == campaignId)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.commentText, commentText) || other.commentText == commentText)&&(identical(other.parentId, parentId) || other.parentId == parentId)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.username, username) || other.username == username)&&(identical(other.displayName, displayName) || other.displayName == displayName)&&(identical(other.avatarUrl, avatarUrl) || other.avatarUrl == avatarUrl)&&const DeepCollectionEquality().equals(other._replies, _replies));
}


@override
int get hashCode => Object.hash(runtimeType,id,campaignId,userId,commentText,parentId,createdAt,username,displayName,avatarUrl,const DeepCollectionEquality().hash(_replies));
...
/// Create a copy of CampaignCommentEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? campaignId = null,Object? userId = null,Object? commentText = null,Object? parentId = freezed,Object? createdAt = null,Object? username = freezed,Object? displayName = freezed,Object? avatarUrl = freezed,Object? replies = null,}) {
