...
mixin _$CampaignUpdateEntity {
 ...
 String get id; String get campaignId; String get updateText; String? get imageUrl; DateTime get createdAt;
...
@override
int get hashCode => Object.hash(runtimeType,id,campaignId,updateText,imageUrl,createdAt);
...
@useResult
$Res call({
 String id, String campaignId, String updateText, String? imageUrl, DateTime createdAt
});
...
/// Create a copy of CampaignUpdateEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? campaignId = null,Object? updateText = null,Object? imageUrl = freezed,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String campaignId,  String updateText,  String? imageUrl,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CampaignUpdateEntity() when $default != null:
return $default(_that.id,_that.campaignId,_that.updateText,_that.imageUrl,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String campaignId,  String updateText,  String? imageUrl,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _CampaignUpdateEntity():
return $default(_that.id,_that.campaignId,_that.updateText,_that.imageUrl,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String campaignId,  String updateText,  String? imageUrl,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _CampaignUpdateEntity() when $default != null:
return $default(_that.id,_that.campaignId,_that.updateText,_that.imageUrl,_that.createdAt);case _:
  return null;
...
class _CampaignUpdateEntity implements CampaignUpdateEntity {
  const _CampaignUpdateEntity({required this.id, required this.campaignId, required this.updateText, this.imageUrl, required this.createdAt});
...
/// Create a copy of CampaignUpdateEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? campaignId = null,Object? updateText = null,Object? imageUrl = freezed,Object? createdAt = null,}) {
