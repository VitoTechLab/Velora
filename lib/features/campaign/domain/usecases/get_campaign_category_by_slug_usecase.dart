...
class GetCampaignCategoryBySlugUsecase {
  const GetCampaignCategoryBySlugUsecase({required this.repository});

  final CampaignRepository repository;

  Future<Either<Failure, CampaignCategoryEntity?>> call(String slug) {
