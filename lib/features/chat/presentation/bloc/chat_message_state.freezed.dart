...
@override
int get hashCode => Object.hashAll([runtimeType,const DeepCollectionEquality().hash(messages),conversationId,unreadCount,hasMore,cursor,isLoading,isLoadingMore,errorMessage,isSending,sendError,sentMessage,isEditing,editError,editedMessage,isDeleting,deleteError,isMarkingRead,markReadError,message,isWatching,watchError,const DeepCollectionEquality().hash(conversations),isLoadingConversations,conversationsError,selectedFilter,searchQuery,const DeepCollectionEquality().hash(messageReads),isLoadingReads,readsError,isWatchingReads,const DeepCollectionEquality().hash(typingUsers),isWatchingTyping]);
...
switch (_that) {
case _ChatMessageState() when $default != null:
return $default(_that.messages,_that.conversationId,_that.unreadCount,_that.hasMore,_that.cursor,_that.isLoading,_that.isLoadingMore,_that.errorMessage,_that.isSending,_that.sendError,_that.sentMessage,_that.isEditing,_that.editError,_that.editedMessage,_that.isDeleting,_that.deleteError,_that.isMarkingRead,_that.markReadError,_that.message,_that.isWatching,_that.watchError,_that.conversations,_that.isLoadingConversations,_that.conversationsError,_that.selectedFilter,_that.searchQuery,_that.messageReads,_that.isLoadingReads,_that.readsError,_that.isWatchingReads,_that.typingUsers,_that.isWatchingTyping);case _:
  return orElse();
...
@override
int get hashCode => Object.hashAll([runtimeType,const DeepCollectionEquality().hash(_messages),conversationId,unreadCount,hasMore,cursor,isLoading,isLoadingMore,errorMessage,isSending,sendError,sentMessage,isEditing,editError,editedMessage,isDeleting,deleteError,isMarkingRead,markReadError,message,isWatching,watchError,const DeepCollectionEquality().hash(_conversations),isLoadingConversations,conversationsError,selectedFilter,searchQuery,const DeepCollectionEquality().hash(_messageReads),isLoadingReads,readsError,isWatchingReads,const DeepCollectionEquality().hash(_typingUsers),isWatchingTyping]);
