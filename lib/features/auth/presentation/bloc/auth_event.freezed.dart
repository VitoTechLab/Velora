...
return resetPassword(_that);case ResendEmailVerificationEvent() when resendEmailVerification != null:
return resendEmailVerification(_that);case SignOutEvent() when signOut != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String email,  String password)?  signUp,TResult Function( String email,  String password)?  signIn,TResult Function( String email)?  resetPassword,TResult Function( String? email)?  resendEmailVerification,TResult Function()?  signOut,TResult Function()?  signInWithGoogle,TResult Function()?  clearMessages,TResult Function( AuthSnapshotEntity snapshot)?  authSnapshotChanged,required TResult orElse(),}) {final _that = this;
switch (_that) {
case SignUpEvent() when signUp != null:
...
return resetPassword(_that.email);case ResendEmailVerificationEvent() when resendEmailVerification != null:
return resendEmailVerification(_that.email);case SignOutEvent() when signOut != null:
...
return resetPassword(_that.email);case ResendEmailVerificationEvent():
return resendEmailVerification(_that.email);case SignOutEvent():
...
class ResendEmailVerificationEvent implements AuthEvent {
  const ResendEmailVerificationEvent({this.email});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ResendEmailVerificationEventCopyWith<ResendEmailVerificationEvent> get copyWith => _$ResendEmailVerificationEventCopyWithImpl<ResendEmailVerificationEvent>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ResendEmailVerificationEvent&&(identical(other.email, email) || other.email == email));
}
...
@override
String toString() {
  return 'AuthEvent.resendEmailVerification(email: $email)';
}
...
/// @nodoc
abstract mixin class $ResendEmailVerificationEventCopyWith<$Res> implements $AuthEventCopyWith<$Res> {
  factory $ResendEmailVerificationEventCopyWith(ResendEmailVerificationEvent value, $Res Function(ResendEmailVerificationEvent) _then) = _$ResendEmailVerificationEventCopyWithImpl;
@useResult
$Res call({
 String? email
});
...
/// @nodoc
class _$ResendEmailVerificationEventCopyWithImpl<$Res>
    implements $ResendEmailVerificationEventCopyWith<$Res> {
  _$ResendEmailVerificationEventCopyWithImpl(this._self, this._then);

  final ResendEmailVerificationEvent _self;
  final $Res Function(ResendEmailVerificationEvent) _then;

/// Create a copy of AuthEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? email = freezed,}) {
  return _then(ResendEmailVerificationEvent(
