...
mixin _$CommentEntity {
 ...
 String get id; String get postId; String get userId; String get content; DateTime get createdAt; String? get username; String? get photoUrl; int get likesCount; bool get isLiked; String? get parentCommentId; List<CommentEntity> get replies; int get replyCount; bool get repliesLoaded; bool get isLoadingReplies; List<String> get mentionIds; bool get isActive;
...
@useResult
$Res call({
 String id, String postId, String userId, String content, DateTime createdAt, String? username, String? photoUrl, int likesCount, bool isLiked, String? parentCommentId, List<CommentEntity> replies, int replyCount, bool repliesLoaded, bool isLoadingReplies, List<String> mentionIds, bool isActive
});
...
/// Create a copy of CommentEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? postId = null,Object? userId = null,Object? content = null,Object? createdAt = null,Object? username = freezed,Object? photoUrl = freezed,Object? likesCount = null,Object? isLiked = null,Object? parentCommentId = freezed,Object? replies = null,Object? replyCount = null,Object? repliesLoaded = null,Object? isLoadingReplies = null,Object? mentionIds = null,Object? isActive = null,}) {
...
as bool,mentionIds: null == mentionIds ? _self.mentionIds : mentionIds // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String postId,  String userId,  String content,  DateTime createdAt,  String? username,  String? photoUrl,  int likesCount,  bool isLiked,  String? parentCommentId,  List<CommentEntity> replies,  int replyCount,  bool repliesLoaded,  bool isLoadingReplies,  List<String> mentionIds,  bool isActive)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CommentEntity() when $default != null:
return $default(_that.id,_that.postId,_that.userId,_that.content,_that.createdAt,_that.username,_that.photoUrl,_that.likesCount,_that.isLiked,_that.parentCommentId,_that.replies,_that.replyCount,_that.repliesLoaded,_that.isLoadingReplies,_that.mentionIds,_that.isActive);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String postId,  String userId,  String content,  DateTime createdAt,  String? username,  String? photoUrl,  int likesCount,  bool isLiked,  String? parentCommentId,  List<CommentEntity> replies,  int replyCount,  bool repliesLoaded,  bool isLoadingReplies,  List<String> mentionIds,  bool isActive)  $default,) {final _that = this;
switch (_that) {
case _CommentEntity():
return $default(_that.id,_that.postId,_that.userId,_that.content,_that.createdAt,_that.username,_that.photoUrl,_that.likesCount,_that.isLiked,_that.parentCommentId,_that.replies,_that.replyCount,_that.repliesLoaded,_that.isLoadingReplies,_that.mentionIds,_that.isActive);case _:
  throw StateError('Unexpected subclass');
...
class _CommentEntity implements CommentEntity {
  const _CommentEntity({required this.id, required this.postId, required this.userId, required this.content, required this.createdAt, this.username, this.photoUrl, this.likesCount = 0, this.isLiked = false, this.parentCommentId, final  List<CommentEntity> replies = const [], this.replyCount = 0, this.repliesLoaded = false, this.isLoadingReplies = false, final  List<String> mentionIds = const [], this.isActive = true}): _replies = replies,_mentionIds = mentionIds;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CommentEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.postId, postId) || other.postId == postId)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.content, content) || other.content == content)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.username, username) || other.username == username)&&(identical(other.photoUrl, photoUrl) || other.photoUrl == photoUrl)&&(identical(other.likesCount, likesCount) || other.likesCount == likesCount)&&(identical(other.isLiked, isLiked) || other.isLiked == isLiked)&&(identical(other.parentCommentId, parentCommentId) || other.parentCommentId == parentCommentId)&&const DeepCollectionEquality().equals(other._replies, _replies)&&(identical(other.replyCount, replyCount) || other.replyCount == replyCount)&&(identical(other.repliesLoaded, repliesLoaded) || other.repliesLoaded == repliesLoaded)&&(identical(other.isLoadingReplies, isLoadingReplies) || other.isLoadingReplies == isLoadingReplies)&&const DeepCollectionEquality().equals(other._mentionIds, _mentionIds)&&(identical(other.isActive, isActive) || other.isActive == isActive));
}


@override
int get hashCode => Object.hash(runtimeType,id,postId,userId,content,createdAt,username,photoUrl,likesCount,isLiked,parentCommentId,const DeepCollectionEquality().hash(_replies),replyCount,repliesLoaded,isLoadingReplies,const DeepCollectionEquality().hash(_mentionIds),isActive);
...
as int,repliesLoaded: null == repliesLoaded ? _self.repliesLoaded : repliesLoaded // ignore: cast_nullable_to_non_nullable
as bool,isLoadingReplies: null == isLoadingReplies ? _self.isLoadingReplies : isLoadingReplies // ignore: cast_nullable_to_non_nullable
as bool,mentionIds: null == mentionIds ? _self._mentionIds : mentionIds // ignore: cast_nullable_to_non_nullable
as List<String>,isActive: null == isActive ? _self.isActive : isActive // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
