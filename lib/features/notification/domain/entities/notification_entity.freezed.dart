...
@override
String toString() {
  return 'NotificationEntity(id: $id, userId: $userId, actorId: $actorId, type: $type, targetId: $targetId, targetType: $targetType, groupKey: $groupKey, groupCount: $groupCount, isRead: $isRead, createdAt: $createdAt, updatedAt: $updatedAt, actorUsername: $actorUsername, actorPhotoUrl: $actorPhotoUrl, targetPreviewUrl: $targetPreviewUrl)';
}
...
@useResult
$Res call({
 String id, String userId, String? actorId, NotificationType type, String? targetId, NotificationTargetType? targetType, String? groupKey, int groupCount, bool isRead, DateTime createdAt, DateTime? updatedAt, String? actorUsername, String? actorPhotoUrl, String? targetPreviewUrl
});
...
class _NotificationEntity extends NotificationEntity {
  const _NotificationEntity({required this.id, required this.userId, this.actorId, required this.type, this.targetId, this.targetType, this.groupKey, this.groupCount = 1, this.isRead = false, required this.createdAt, this.updatedAt, this.actorUsername, this.actorPhotoUrl, this.targetPreviewUrl}): super._();
