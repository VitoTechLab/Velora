...
mixin _$ProfileState {
 ...
 bool get isLoading; UserProfileModel? get profile; String? get error; bool get isFollowing; bool get isBlocked; bool get isFollowRequestPending;
...
@useResult
$Res call({
 bool isLoading, UserProfileModel? profile, String? error, bool isFollowing, bool isBlocked, bool isFollowRequestPending
});
...
as UserProfileModel?,error: freezed == error ? _self.error : error // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isLoading,  UserProfileModel? profile,  String? error,  bool isFollowing,  bool isBlocked,  bool isFollowRequestPending)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProfileState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isLoading,  UserProfileModel? profile,  String? error,  bool isFollowing,  bool isBlocked,  bool isFollowRequestPending)  $default,) {final _that = this;
switch (_that) {
case _ProfileState():
return $default(_that.isLoading,_that.profile,_that.error,_that.isFollowing,_that.isBlocked,_that.isFollowRequestPending);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isLoading,  UserProfileModel? profile,  String? error,  bool isFollowing,  bool isBlocked,  bool isFollowRequestPending)?  $default,) {final _that = this;
switch (_that) {
case _ProfileState() when $default != null:
return $default(_that.isLoading,_that.profile,_that.error,_that.isFollowing,_that.isBlocked,_that.isFollowRequestPending);case _:
  return null;
