...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( LoadProfileEvent value)?  loadProfile,TResult Function( ToggleFollowEvent value)?  toggleFollow,TResult Function( BlockUserEvent value)?  blockUser,TResult Function( UnblockUserEvent value)?  unblockUser,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( LoadProfileEvent value)  loadProfile,required TResult Function( ToggleFollowEvent value)  toggleFollow,required TResult Function( BlockUserEvent value)  blockUser,required TResult Function( UnblockUserEvent value)  unblockUser,}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( LoadProfileEvent value)?  loadProfile,TResult? Function( ToggleFollowEvent value)?  toggleFollow,TResult? Function( BlockUserEvent value)?  blockUser,TResult? Function( UnblockUserEvent value)?  unblockUser,}){
final _that = this;
switch (_that) {
case LoadProfileEvent() when loadProfile != null:
return loadProfile(_that);case ToggleFollowEvent() when toggleFollow != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String userId)?  loadProfile,TResult Function( String targetUserId,  bool isPrivate)?  toggleFollow,TResult Function( String targetUserId)?  blockUser,TResult Function( String targetUserId)?  unblockUser,required TResult orElse(),}) {final _that = this;
switch (_that) {
case LoadProfileEvent() when loadProfile != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String userId)  loadProfile,required TResult Function( String targetUserId,  bool isPrivate)  toggleFollow,required TResult Function( String targetUserId)  blockUser,required TResult Function( String targetUserId)  unblockUser,}) {final _that = this;
switch (_that) {
case LoadProfileEvent():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String userId)?  loadProfile,TResult? Function( String targetUserId,  bool isPrivate)?  toggleFollow,TResult? Function( String targetUserId)?  blockUser,TResult? Function( String targetUserId)?  unblockUser,}) {final _that = this;
switch (_that) {
case LoadProfileEvent() when loadProfile != null:
return loadProfile(_that.userId);case ToggleFollowEvent() when toggleFollow != null:
return toggleFollow(_that.targetUserId,_that.isPrivate);case BlockUserEvent() when blockUser != null:
