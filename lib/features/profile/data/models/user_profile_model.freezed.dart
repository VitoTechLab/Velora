...
mixin _$UserProfileModel {
 ...
 String get id; String get email; String get username;@JsonKey(name: 'full_name') String? get fullName;@JsonKey(name: 'avatar_url') String? get avatarUrl;@JsonKey(name: 'is_private') bool get isPrivate;@JsonKey(name: 'followers_count') int get followersCount;@JsonKey(name: 'following_count') int get followingCount;@UtcDateTimeConverter()@JsonKey(name: 'created_at') DateTime get createdAt;@UtcDateTimeConverter()@JsonKey(name: 'updated_at') DateTime get updatedAt;@JsonKey(name: 'is_me') bool get isMe;@JsonKey(name: 'is_following') bool get isFollowing;@JsonKey(name: 'is_follow_request_pending') bool get isFollowRequestPending;@JsonKey(name: 'i_blocked_them') bool get iBlockedThem;@JsonKey(name: 'they_blocked_me') bool get theyBlockedMe;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,email,username,fullName,avatarUrl,isPrivate,followersCount,followingCount,createdAt,updatedAt,isMe,isFollowing,isFollowRequestPending,iBlockedThem,theyBlockedMe);
...
@useResult
$Res call({
 String id, String email, String username,@JsonKey(name: 'full_name') String? fullName,@JsonKey(name: 'avatar_url') String? avatarUrl,@JsonKey(name: 'is_private') bool isPrivate,@JsonKey(name: 'followers_count') int followersCount,@JsonKey(name: 'following_count') int followingCount,@UtcDateTimeConverter()@JsonKey(name: 'created_at') DateTime createdAt,@UtcDateTimeConverter()@JsonKey(name: 'updated_at') DateTime updatedAt,@JsonKey(name: 'is_me') bool isMe,@JsonKey(name: 'is_following') bool isFollowing,@JsonKey(name: 'is_follow_request_pending') bool isFollowRequestPending,@JsonKey(name: 'i_blocked_them') bool iBlockedThem,@JsonKey(name: 'they_blocked_me') bool theyBlockedMe
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String email,  String username, @JsonKey(name: 'full_name')  String? fullName, @JsonKey(name: 'avatar_url')  String? avatarUrl, @JsonKey(name: 'is_private')  bool isPrivate, @JsonKey(name: 'followers_count')  int followersCount, @JsonKey(name: 'following_count')  int followingCount, @UtcDateTimeConverter()@JsonKey(name: 'created_at')  DateTime createdAt, @UtcDateTimeConverter()@JsonKey(name: 'updated_at')  DateTime updatedAt, @JsonKey(name: 'is_me')  bool isMe, @JsonKey(name: 'is_following')  bool isFollowing, @JsonKey(name: 'is_follow_request_pending')  bool isFollowRequestPending, @JsonKey(name: 'i_blocked_them')  bool iBlockedThem, @JsonKey(name: 'they_blocked_me')  bool theyBlockedMe)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserProfileModel() when $default != null:
return $default(_that.id,_that.email,_that.username,_that.fullName,_that.avatarUrl,_that.isPrivate,_that.followersCount,_that.followingCount,_that.createdAt,_that.updatedAt,_that.isMe,_that.isFollowing,_that.isFollowRequestPending,_that.iBlockedThem,_that.theyBlockedMe);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String email,  String username, @JsonKey(name: 'full_name')  String? fullName, @JsonKey(name: 'avatar_url')  String? avatarUrl, @JsonKey(name: 'is_private')  bool isPrivate, @JsonKey(name: 'followers_count')  int followersCount, @JsonKey(name: 'following_count')  int followingCount, @UtcDateTimeConverter()@JsonKey(name: 'created_at')  DateTime createdAt, @UtcDateTimeConverter()@JsonKey(name: 'updated_at')  DateTime updatedAt, @JsonKey(name: 'is_me')  bool isMe, @JsonKey(name: 'is_following')  bool isFollowing, @JsonKey(name: 'is_follow_request_pending')  bool isFollowRequestPending, @JsonKey(name: 'i_blocked_them')  bool iBlockedThem, @JsonKey(name: 'they_blocked_me')  bool theyBlockedMe)  $default,) {final _that = this;
switch (_that) {
case _UserProfileModel():
return $default(_that.id,_that.email,_that.username,_that.fullName,_that.avatarUrl,_that.isPrivate,_that.followersCount,_that.followingCount,_that.createdAt,_that.updatedAt,_that.isMe,_that.isFollowing,_that.isFollowRequestPending,_that.iBlockedThem,_that.theyBlockedMe);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String email,  String username, @JsonKey(name: 'full_name')  String? fullName, @JsonKey(name: 'avatar_url')  String? avatarUrl, @JsonKey(name: 'is_private')  bool isPrivate, @JsonKey(name: 'followers_count')  int followersCount, @JsonKey(name: 'following_count')  int followingCount, @UtcDateTimeConverter()@JsonKey(name: 'created_at')  DateTime createdAt, @UtcDateTimeConverter()@JsonKey(name: 'updated_at')  DateTime updatedAt, @JsonKey(name: 'is_me')  bool isMe, @JsonKey(name: 'is_following')  bool isFollowing, @JsonKey(name: 'is_follow_request_pending')  bool isFollowRequestPending, @JsonKey(name: 'i_blocked_them')  bool iBlockedThem, @JsonKey(name: 'they_blocked_me')  bool theyBlockedMe)?  $default,) {final _that = this;
switch (_that) {
case _UserProfileModel() when $default != null:
return $default(_that.id,_that.email,_that.username,_that.fullName,_that.avatarUrl,_that.isPrivate,_that.followersCount,_that.followingCount,_that.createdAt,_that.updatedAt,_that.isMe,_that.isFollowing,_that.isFollowRequestPending,_that.iBlockedThem,_that.theyBlockedMe);case _:
  return null;
