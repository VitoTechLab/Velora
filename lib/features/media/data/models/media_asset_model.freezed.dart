...
@JsonKey(name: 'public_id') String get publicId;@JsonKey(name: 'secure_url') String get secureUrl;@JsonKey(name: 'resource_type') String get resourceType;@JsonKey(name: 'format') String get format;@JsonKey(name: 'bytes') int get bytes;@JsonKey(name: 'width') int get width;@JsonKey(name: 'height') int get height;
...
@useResult
$Res call({
@JsonKey(name: 'public_id') String publicId,@JsonKey(name: 'secure_url') String secureUrl,@JsonKey(name: 'resource_type') String resourceType,@JsonKey(name: 'format') String format,@JsonKey(name: 'bytes') int bytes,@JsonKey(name: 'width') int width,@JsonKey(name: 'height') int height
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'public_id')  String publicId, @JsonKey(name: 'secure_url')  String secureUrl, @JsonKey(name: 'resource_type')  String resourceType, @JsonKey(name: 'format')  String format, @JsonKey(name: 'bytes')  int bytes, @JsonKey(name: 'width')  int width, @JsonKey(name: 'height')  int height)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MediaAssetModel() when $default != null:
